      ...
      <div className="weather-card__current">
        <div className="weather-card__main">
          <div className="weather-card__temp-row">
            ...
            <span className="weather-card__temp">{weather.temperature}°C</span>
          </div>
          <p className="weather-card__desc">{weather.weatherDesc} · 体感{weather.feelsLike}°C</p>
        </div>
        <div className="weather-card__info">
          <p className="weather-card__city">{weather.city} · 实时天气</p>
          <p className="weather-card__humidity">湿度 {weather.humidity}%</p>
        </div>
      </div>
        ...
        <div className="weather-card__forecast">
          {weather.forecast.map((day, i) => (
            <div key={i} className="weather-card__forecast-item">
              ...
              <p className="weather-card__forecast-temp">{day.minTemp}~{day.maxTemp}°C</p>
